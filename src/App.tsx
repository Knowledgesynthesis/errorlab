    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center text-sm text-gray-600">
          <p className="mb-2">
            <strong>ErrorLab</strong> – An interactive educational tool for learning hypothesis testing
          </p>
          <p>
            Built with React, TypeScript, Tailwind CSS, and Recharts
          </p>
          <p className="mt-4 text-xs text-gray-500">
            For educational purposes. All statistical calculations are approximations.
          </p>
        </div>
      </div>
    </footer>
